...
"[project]/src/app/api/v1/ctf/[id]/submit/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    ...
    if (!flag || !userAlias) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'flag and userAlias required'
        }, {
            status: 400
        });
    }
    const challenge = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFChallenge.findUnique({
        where: {
            id
        }
    });
    ...
    const submitted = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createHash"])('sha256').update(flag.trim()).digest('hex');
    const correct = submitted === challenge.flagHash;
    if (correct) {
        // Record solve (idempotent)
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFSolve.upsert({
            where: {
                challengeId_userAlias: {
                    challengeId: id,
                    userAlias
                }
            },
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ce2eb2._.js.map