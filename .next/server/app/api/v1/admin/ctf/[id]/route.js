(()=>{var e={};e.id=6781,e.ids=[6781],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},55511:e=>{"use strict";e.exports=require("crypto")},50662:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>v,routeModule:()=>g,serverHooks:()=>b,workAsyncStorage:()=>m,workUnitAsyncStorage:()=>x});var a={};r.r(a),r.d(a,{DELETE:()=>f,PATCH:()=>h,POST:()=>u});var o=r(42706),s=r(28203),n=r(45994),i=r(39187),l=r(43219),p=r(92043),c=r(14702);async function d(e){try{let t=await fetch(`http://localhost:8000/api/v1/admin/users?search=${e}`,{headers:{"X-Internal":"true"}});if(t.ok){let r=((await t.json()).users??[]).find(t=>t.username===e);return r?.email??null}}catch{}return null}async function u(e,{params:t}){let r=(0,p.ZT)(e);if(r instanceof i.NextResponse)return r;let{id:a}=await t,{status:o,reviewNote:s}=await e.json();if(!["approved","rejected"].includes(o))return i.NextResponse.json({error:"status must be approved or rejected"},{status:400});let n=await l.z.cTFChallenge.update({where:{id:a},data:{status:o,reviewNote:s??null,reviewedBy:r.alias,reviewedAt:new Date}});if(await l.z.notification.create({data:{userAlias:n.authorAlias??"anonymous",type:"system",title:"approved"===o?"✅ CTF Challenge Approved!":"❌ CTF Challenge Rejected",body:"approved"===o?`Your challenge "${n.title}" is now live.`:`Your challenge "${n.title}" was not approved. ${s??""}`,link:"/ctf"}}).catch(()=>null),n.authorAlias&&"anonymous"!==n.authorAlias){let e=await d(n.authorAlias);e&&"approved"===o&&await (0,c.Z)({to:e,...c.k.ctfApproved(n.authorAlias,n.title)}).catch(()=>null)}return i.NextResponse.json({ok:!0,challenge:n})}async function h(e,{params:t}){let r=(0,p.ZT)(e);if(r instanceof i.NextResponse)return r;let{id:a}=await t,o=await e.json(),s=o.status??("approve"===o.action?"approved":"rejected"),n=await l.z.cTFChallenge.update({where:{id:a},data:{status:s,reviewNote:o.note??null,reviewedBy:r.alias,reviewedAt:new Date}});return i.NextResponse.json(n)}async function f(e,{params:t}){let r=(0,p.ZT)(e);if(r instanceof i.NextResponse)return r;let{id:a}=await t;return await l.z.cTFChallenge.delete({where:{id:a}}),i.NextResponse.json({ok:!0})}let g=new o.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/v1/admin/ctf/[id]/route",pathname:"/api/v1/admin/ctf/[id]",filename:"route",bundlePath:"app/api/v1/admin/ctf/[id]/route"},resolvedPagePath:"/home/idiot/Projects/Claude/xcloak/src/app/api/v1/admin/ctf/[id]/route.ts",nextConfigOutput:"",userland:a}),{workAsyncStorage:m,workUnitAsyncStorage:x,serverHooks:b}=g;function v(){return(0,n.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:x})}},96487:()=>{},78335:()=>{},92043:(e,t,r)=>{"use strict";r.d(t,{Er:()=>c,O7:()=>d,ZT:()=>p,zF:()=>n});var a=r(39187),o=r(55511);let s=process.env.ADMIN_SECRET??"xcloak-admin-secret-change-me";function n(e){let t=Buffer.from(JSON.stringify({alias:e,exp:Date.now()+288e5})).toString("base64url"),r=(0,o.createHash)("sha256").update(`${t}.${s}`).digest("base64url");return`${t}.${r}`}function i(e){try{let t=e.split(".");if(2!==t.length)return null;let[r,a]=t,n=(0,o.createHash)("sha256").update(`${r}.${s}`).digest("base64url"),i=Buffer.from(a,"base64url"),l=Buffer.from(n,"base64url");if(i.length!==l.length||!(0,o.timingSafeEqual)(i,l))return null;let p=JSON.parse(Buffer.from(r,"base64url").toString());if(p.exp<Date.now())return null;return{alias:p.alias}}catch{return null}}function l(e){try{let t=e.split(".");if(3!==t.length)return null;let[,r]=t,a=JSON.parse(Buffer.from(r,"base64url").toString());if(a.exp&&1e3*a.exp<Date.now()||"admin"!==a.role)return null;return{alias:a.email?.split("@")[0]??a.sub??"admin"}}catch{return null}}function p(e){let t=e.cookies.get("xcloak-admin")?.value;if(t){let e=i(t);if(e)return e}let r=e.headers.get("x-admin-token")??"";if(r){let e=i(r);if(e)return e;let t=l(r);if(t)return t}let o=(e.headers.get("authorization")??"").replace(/^Bearer /i,"").trim();if(o){let e=l(o);if(e)return e}return a.NextResponse.json({error:"Unauthorized"},{status:401})}function c(e){return(0,o.createHash)("sha256").update(`${e}.${s}`).digest("hex")}function d(e,t){let r=c(e);return(0,o.timingSafeEqual)(Buffer.from(r),Buffer.from(t))}},14702:(e,t,r)=>{"use strict";r.d(t,{Z:()=>s,k:()=>i});let a=process.env.EMAIL_FROM??"XCloak <admin@xcloak.tech>",o=process.env.RESEND_API_KEY??"";async function s(e){if(!o)return console.log("[email] No RESEND_API_KEY — would have sent:",e.subject,"→",e.to),!1;try{let t=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${o}`,"Content-Type":"application/json"},body:JSON.stringify({from:a,to:Array.isArray(e.to)?e.to:[e.to],subject:e.subject,html:e.html,reply_to:e.replyTo})});if(!t.ok){let e=await t.text();return console.error("[email] Resend error:",e),!1}return!0}catch(e){return console.error("[email] fetch failed:",e),!1}}let n=e=>`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
