...
"[project]/src/lib/nvd.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/v1/cve/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$nvd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/nvd.ts [app-route] (ecmascript)");
;
;
;
...
async function GET(req) {
    ...
    try {
        ...
        if (q) {
            const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$nvd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchCVEs"])(q, limit);
        ...
        let cves = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cVECache.findMany({
            where,
            orderBy: {
                cvssScore: 'desc'
            },
        ...
        if (cves.length === 0) {
            ...
            const { vulns: fresh } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$nvd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchRecentCVEs"])({
                daysBack: 30,
                limit: 200
            });
            await Promise.all(fresh.map((cve)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cVECache.upsert({
                    where: {
                        cveId: cve.cveId
                    },
                    create: {
            ...
            cves = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cVECache.findMany({
                where,
                orderBy: {
                    cvssScore: 'desc'
                },
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(cves);
    } catch (err) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a68b18._.js.map