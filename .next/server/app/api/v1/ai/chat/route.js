(()=>{var e={};e.id=7951,e.ids=[7951],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},4343:(e,t,a)=>{"use strict";a.r(t),a.d(t,{patchFetch:()=>g,routeModule:()=>p,serverHooks:()=>m,workAsyncStorage:()=>u,workUnitAsyncStorage:()=>d});var s={};a.r(s),a.d(s,{POST:()=>l});var i=a(2706),r=a(8203),n=a(5994),o=a(9187);let c=`You are XcloakAI, a senior cybersecurity expert embedded in the Xcloak platform.
...
- Keep responses under 400 words unless asked for detail`;async function l(e){let{messages:t}=await e.json();if(!t||!Array.isArray(t))return o.NextResponse.json({error:"messages array required"},{status:400});let a=t[t.length-1]?.content??"";if(a.length>2e3)return o.NextResponse.json({error:"Message too long"},{status:400});let s=process.env.OPENAI_API_KEY;if(s)try{let e=await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${s}`},body:JSON.stringify({model:"gpt-4o-mini",messages:[{role:"system",content:c},...t.slice(-6)],max_tokens:600,temperature:.3})});if(e.ok){let t=await e.json();return o.NextResponse.json({message:t.choices[0].message.content})}}catch(e){console.error("[AI] OpenAI error:",e)}let i=function(e){let t=e.toLowerCase();if(/cve-(\d{4})-(\d+)/.test(t)){let e=t.match(/cve-(\d{4})-(\d+)/i),a=e?.[0].toUpperCase();return`**${a}** — To get detailed analysis, visit:
...
Or ask me about a specific CVE, exploit type, or security concept.`}(a);return o.NextResponse.json({message:i})}let p=new i.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/v1/ai/chat/route",pathname:"/api/v1/ai/chat",filename:"route",bundlePath:"app/api/v1/ai/chat/route"},resolvedPagePath:"/home/idiot/Projects/Claude/xcloak/src/app/api/v1/ai/chat/route.ts",nextConfigOutput:"",userland:s}),{workAsyncStorage:u,workUnitAsyncStorage:d,serverHooks:m}=p;function g(){return(0,n.patchFetch)({workAsyncStorage:u,workUnitAsyncStorage:d})}},6487:()=>{},8335:()=>{}};var t=require("../../../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),s=t.X(0,[638,5452],()=>a(4343));module.exports=s})();