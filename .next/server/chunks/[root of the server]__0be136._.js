...
"[project]/src/app/api/v1/learn/enroll/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!pathId || !alias) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'pathId and alias required'
    }, {
        status: 400
    });
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].learnEnroll.create({
            data: {
                pathId,
                alias
            }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0be136._.js.map