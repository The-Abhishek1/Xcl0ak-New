...
"[project]/src/app/api/v1/ctf/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const challenges = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFChallenge.findMany({
        where: {
            status: 'approved',
            OR: [
                {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(challenges);
}
async function POST(req) {
    const body = await req.json();
    const { title, category, difficulty, description, flag, points, authorAlias, hints, fileUrl } = body;
    if (!title || !category || !flag || !points || !authorAlias) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'title, category, flag, points, authorAlias required'
    }, {
        status: 400
    });
    if (typeof flag !== 'string' || !flag.startsWith('xcloak{')) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Flag must start with xcloak{'
    }, {
        status: 400
    });
    const flagHash = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createHash"])('sha256').update(flag.trim()).digest('hex');
    const challenge = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFChallenge.create({
        data: {
            title,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__233dd0._.js.map