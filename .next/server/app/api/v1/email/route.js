(()=>{var e={};e.id=7199,e.ids=[4702,7199],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},49730:(e,t,o)=>{"use strict";o.r(t),o.d(t,{patchFetch:()=>f,routeModule:()=>d,serverHooks:()=>g,workAsyncStorage:()=>h,workUnitAsyncStorage:()=>u});var r={};o.r(r),o.d(r,{POST:()=>c});var a=o(42706),s=o(28203),n=o(45994),l=o(39187),i=o(14702);let p=process.env.INTERNAL_EMAIL_SECRET??"xcloak-internal";async function c(e){if(e.headers.get("x-internal-secret")!==p)return l.NextResponse.json({error:"Unauthorized"},{status:401});let{event:t,to:o,username:r,data:a}=await e.json();if(!t||!o)return l.NextResponse.json({error:"event and to are required"},{status:400});let s=null;switch(t){case"welcome":s=i.templates.welcome(r??o.split("@")[0]);break;case"scan_complete":s=i.templates.scanComplete(r??o.split("@")[0],a?.target??"Unknown",a?.findings??0);break;case"password_reset":s=i.templates.passwordReset(r??o.split("@")[0],a?.resetLink??"");break;case"ctf_solved":s=i.templates.ctfSolved(r??o.split("@")[0],a?.challengeTitle??"",a?.points??0);break;case"ctf_approved":s=i.templates.ctfApproved(r??o.split("@")[0],a?.challengeTitle??"");break;case"ctf_rejected":s=i.templates.ctfRejected(r??o.split("@")[0],a?.challengeTitle??"",a?.reason??"");break;case"exploit_approved":s=i.templates.exploitApproved(r??o.split("@")[0],a?.title??"");break;case"exploit_rejected":s=i.templates.exploitRejected(r??o.split("@")[0],a?.title??"",a?.reason??"");break;case"learning_path_approved":s=i.templates.learningPathApproved(r??o.split("@")[0],a?.pathTitle??"");break;case"learning_path_rejected":s=i.templates.learningPathRejected(r??o.split("@")[0],a?.pathTitle??"",a?.reason??"");break;default:return l.NextResponse.json({error:`Unknown event: ${t}`},{status:400})}let n=await (0,i.sendEmail)({to:o,...s});return l.NextResponse.json({ok:n})}let d=new a.AppRouteRouteModule({definition:{kind:s.RouteKind.APP_ROUTE,page:"/api/v1/email/route",pathname:"/api/v1/email",filename:"route",bundlePath:"app/api/v1/email/route"},resolvedPagePath:"/home/idiot/Projects/Claude/xcloak/src/app/api/v1/email/route.ts",nextConfigOutput:"",userland:r}),{workAsyncStorage:h,workUnitAsyncStorage:u,serverHooks:g}=d;function f(){return(0,n.patchFetch)({workAsyncStorage:h,workUnitAsyncStorage:u})}},96487:()=>{},78335:()=>{},14702:(e,t,o)=>{"use strict";o.d(t,{sendEmail:()=>s,templates:()=>l});let r=process.env.EMAIL_FROM??"XCloak <admin@xcloak.tech>",a=process.env.RESEND_API_KEY??"";async function s(e){if(!a)return console.log("[email] No RESEND_API_KEY — would have sent:",e.subject,"→",e.to),!1;try{let t=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${a}`,"Content-Type":"application/json"},body:JSON.stringify({from:r,to:Array.isArray(e.to)?e.to:[e.to],subject:e.subject,html:e.html,reply_to:e.replyTo})});if(!t.ok){let e=await t.text();return console.error("[email] Resend error:",e),!1}return!0}catch(e){return console.error("[email] fetch failed:",e),!1}}let n=e=>`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
`,l={welcome:e=>({subject:"\uD83D\uDEE1 Welcome to XCloak — your security journey starts now",html:n(`
    ...
    `)})}}};var t=require("../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),r=t.X(0,[638,5452],()=>o(49730));module.exports=r})();