...
"[project]/src/lib/otx.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/v1/threat/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$otx$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/otx.ts [app-route] (ecmascript)");
;
;
;
...
async function GET(req) {
    ...
    try {
        if (view === 'pulses') {
            const pulses = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$otx$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSubscribedPulses"])(limit);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(pulses);
        }
        if (view === 'stats') {
            ...
            for (const p of pulses){
                ...
                matches.forEach((m)=>cveSet.add(m.toUpperCase()));
            }
        ...
        const dbEvents = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].threatEvent.findMany({
            where: {
                createdAt: {
                    gte: new Date(Date.now() - 24 * 3600_000)
                }
            },
            orderBy: {
                createdAt: 'desc'
        ...
        if (dbEvents.length >= 10) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(dbEvents);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(points.map((pt)=>({
                type: pt.type,
                srcCountry: pt.country,
                dstCountry: pt.country,
                srcLat: pt.lat,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__09f58a._.js.map