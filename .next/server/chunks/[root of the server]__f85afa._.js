...
"[project]/src/app/api/v1/cve/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cVECache.findUnique({
        where: {
            cveId
        }
    }).catch(()=>null);
    if (cached) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(cached);
    try {
        const nvd = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$nvd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchCVEById"])(cveId);
        if (!nvd) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'not found'
        }, {
            status: 404
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f85afa._.js.map