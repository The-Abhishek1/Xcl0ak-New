...
"[project]/src/app/api/v1/scanner/otx/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!domain) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'domain required'
    }, {
        status: 400
    });
    try {
        const res = await fetch(`${OTX_BASE}/indicator/domain/${encodeURIComponent(domain)}/general`, {
            headers: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__cb74f8._.js.map