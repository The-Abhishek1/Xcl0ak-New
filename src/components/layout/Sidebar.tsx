...
export function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      {SECTIONS.map(sec => (
        <div key={sec.label} style={{ marginBottom:'20px', padding:'0 12px' }}>
          ...
          {sec.items.map(item => {
            ...
            return (
              <Link key={item.href} href={item.href} style={{
                ...
                {item.badge && (
                  <span style={{
                    fontFamily:"'Space Mono',monospace", fontSize:'9px', padding:'1px 5px', borderRadius:'3px',
      ...
      <Link href="/admin" style={{
        display:'flex', alignItems:'center', gap:'10px',
        padding:'8px 10px', margin:'0 12px', borderRadius:'8px',
      ...
      {/* Status */}
      <div style={{ marginTop:'12px', margin:'12px 12px 0', padding:'12px', borderRadius:'10px', background:'rgba(0,255,170,0.04)', border:'1px solid rgba(0,255,170,0.08)' }}>
