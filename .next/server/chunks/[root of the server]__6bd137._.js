...
"[project]/src/app/api/v1/learn/complete/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!moduleId || !alias) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'moduleId and alias required'
    }, {
        status: 400
    });
    try {
        // upsert = no crash if already completed
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].learnCompletion.upsert({
            where: {
                moduleId_alias: {
                    moduleId,
                    alias
        ...
        if (mod?.xpReward && isNew) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.updateMany({
                where: {
                    alias
                },
                data: {
                    reputation: {
                        increment: mod.xpReward
                    }
                }
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6bd137._.js.map