...
"[project]/src/app/api/v1/admin/login/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (count === 0) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].adminUser.create({
            data: {
                alias,
                passwordHash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(password)
            }
        });
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$adminAuth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signToken"])(alias);
        ...
        res.cookies.set('xcloak-admin', token, {
            httpOnly: true,
            sameSite: 'lax',
            maxAge: 28800
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a77442._.js.map