...
async function POST(req, { params }) {
    ...
    if (status === 'approved') {
        ...
        if (flag) data.flagHash = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createHash"])('sha256').update(flag.trim()).digest('hex');
    }
    ...
    if (status === 'approved' && challenge.authorAlias !== 'anonymous') {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.upsert({
            where: {
                alias: challenge.authorAlias
            },
            create: {
                alias: challenge.authorAlias,
                fp: challenge.authorAlias,
                reputation: 30,
                badges: []
            },
            update: {
...
async function PATCH(req, { params }) {
    ...
    if (!status || ![
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Provide status or action'
        }, {
            status: 400
        });
    }
    ...
    if (status === 'approved') {
        ...
        if (body.flag) data.flagHash = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createHash"])('sha256').update(body.flag.trim()).digest('hex');
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFChallenge.update({
        where: {
            id
        },
        data
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__88159e._.js.map