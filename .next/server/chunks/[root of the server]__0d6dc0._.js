...
"[project]/src/app/api/v1/admin/leaderboard/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const [users, exploitCounts, ctfSolves] = await Promise.all([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].exploit.groupBy({
            by: [
                'authorAlias'
            ],
            _count: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFSolve.groupBy({
            by: [
                'userAlias'
            ],
            _count: {
    ...
    const exploitMap = Object.fromEntries(exploitCounts.map((e)=>[
            e.authorAlias,
            e._count.id
        ]));
    const ctfMap = Object.fromEntries(ctfSolves.map((e)=>[
            e.userAlias,
            e._count.id
        ]));
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0d6dc0._.js.map