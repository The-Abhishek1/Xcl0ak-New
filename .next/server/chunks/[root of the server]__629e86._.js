...
"[project]/src/app/api/v1/exploits/[id]/comments/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    const { id } = await params;
    const { body, authorAlias, parentId } = await req.json();
    if (!body?.trim() || !authorAlias) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'body and authorAlias required'
        }, {
            status: 400
        });
    }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__629e86._.js.map