...
"[project]/src/app/api/v1/auth-scan/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'ESO backend unreachable'
        }, {
            status: 503
        });
    }
    const data = await res.json().catch(()=>({
            error: `ESO error ${res.status}`
        }));
...
async function GET(req) {
    ...
    if (!scan_id) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    let res;
    try {
        res = await fetch(`${ESO}/api/v1/auth-scan/${scan_id}`, {
            headers: esoHeaders(req)
        });
    } catch  {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__205175._.js.map