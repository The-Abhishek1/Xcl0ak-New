...
const templates = {
    ...
    exploitApproved: (username, title)=>({
    ...
    exploitRejected: (username, title, reason)=>({
    ...
    ctfSolved: (username, challengeTitle, points)=>({
    ...
    learningPathApproved: (username, pathTitle)=>({
    ...
    learningPathRejected: (username, pathTitle, reason)=>({
    ...
    ctfApproved: (username, challengeTitle)=>({
    ...
    scanComplete: (username, target, findings)=>({
...
"[project]/src/app/api/v1/admin/ctf/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
async function getUserEmail(alias) {
    try {
        const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8000") ?? 'http://localhost:8000'}/api/v1/admin/users?search=${alias}`, {
            headers: {
                'X-Internal': 'true'
            }
        });
        if (res.ok) {
            ...
            const user = (d.users ?? []).find((u)=>u.username === alias);
...
async function POST(req, { params }) {
    ...
    const challenge = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFChallenge.update({
        where: {
            id
        },
        data: {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].notification.create({
        data: {
            ...
            body: status === 'approved' ? `Your challenge "${challenge.title}" is now live.` : `Your challenge "${challenge.title}" was not approved. ${reviewNote ?? ''}`,
            link: '/ctf'
        }
    }).catch(()=>null);
    // Email
    if (challenge.authorAlias && challenge.authorAlias !== 'anonymous') {
        ...
        if (email && status === 'approved') {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])({
                to: email,
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["templates"].ctfApproved(challenge.authorAlias, challenge.title)
            }).catch(()=>null);
        }
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(req, { params }) {
    ...
    if (auth instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]) return auth;
    const { id } = await params;
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cTFChallenge.delete({
        where: {
            id
        }
    });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6390bd._.js.map