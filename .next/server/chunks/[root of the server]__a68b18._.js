...
async function GET(req) {
    ...
    try {
        ...
        if (q) {
            const vulns = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$nvd$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchCVEs"])(q, limit);
        ...
        let [cves, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].cVECache.findMany({
                where,
                orderBy: {
                    cvssScore: 'desc'
                },
