...
"[project]/src/app/api/v1/learn/paths/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!title || !modules?.length || !authorAlias) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'title, modules, and authorAlias required'
        }, {
            status: 400
        });
    }
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
        message: 'Learning path submitted for review'
    }, {
        status: 201
    });
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__281d36._.js.map