...
function AuditPage() {
    ...
    const load = async (filter)=>{
        ...
        try {
            ...
            const r = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eso$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["esoSystem"].audit(params);
            setLogs(r.logs ?? []);
            setTotal(r.total ?? 0);
        } catch  {}
        setLoading(false);
...
"[project]/src/app/audit/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_bd1a9b._.js.map