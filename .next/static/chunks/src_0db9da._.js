...
function ScannerPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ScannerPage.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eso$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["esoScans"].list().then({
        ...
        "ScannerPage.useEffect": ()=>{
            ...
            pollRef.current = setInterval({
                "ScannerPage.useEffect": async ()=>{
                    try {
                        const s = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eso$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["esoScans"].status(processId);
                        setStatus(s);
    ...
    async function startScan() {
        ...
        setScanning(true);
        try {
            const r = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$eso$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["esoScans"].execute(goal, target.trim());
