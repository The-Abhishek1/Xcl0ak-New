...
function useScanWS(processId) {
    ...
    const wsFailRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0) // count consecutive WS failures
    ;
    const addEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useScanWS.useCallback[addEvent]": (ev)=>{
            const key = `${ev.timestamp}:${ev.type}:${JSON.stringify(ev.data).slice(0, 50)}`;
            if (seenRef.current.has(key)) return;
            seenRef.current.add(key);
            setEvents({
                "useScanWS.useCallback[addEvent]": (prev)=>[
                        ...prev,
                        ev
                    ]
            }["useScanWS.useCallback[addEvent]"]);
        }
    }["useScanWS.useCallback[addEvent]"], []);
    // HTTP polling fallback — used when WS fails in production
    const startPollingFallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useScanWS.useCallback[startPollingFallback]": ()=>{
            if (!processId || pollRef.current) return;
            setState('disconnected');
            pollRef.current = setInterval({
                "useScanWS.useCallback[startPollingFallback]": async ()=>{
                    const evs = await fetchEvents(processId);
                    evs.forEach(addEvent);
                }
            }["useScanWS.useCallback[startPollingFallback]"], 3000);
        }
    }["useScanWS.useCallback[startPollingFallback]"], [
        processId,
        addEvent
    ...
    const stopPolling = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useScanWS.useCallback[stopPolling]": ()=>{
            if (pollRef.current) {
        ...
        "useScanWS.useCallback[connect]": ()=>{
            ...
            try {
                ...
                const timeout = setTimeout({
                    "useScanWS.useCallback[connect].timeout": ()=>{
                        if (ws.readyState !== WebSocket.OPEN) {
                            ws.close();
                        }
                    }
                }["useScanWS.useCallback[connect].timeout"], 5000) // 5s connection timeout
                ;
                ws.onopen = ({
                    "useScanWS.useCallback[connect]": ()=>{
...
_s(useScanWS, "7Pd2BUFwfc1tJNNeFQDIAYYxKDM=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
